...
from friend.views import send_friend_request, get_friend_requests, accept_friend_request, remove_friend, \
    decline_friend_request, cancel_friend_request, friend_list_view

app_name = "friend"

urlpatterns = [
    path('friend_request/', send_friend_request, name="friend-request"),
    path('friend_request/<user_id>', get_friend_requests, name="friend-requests"),
